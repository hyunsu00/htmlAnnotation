...
export default class LocalUserStoreAdapter extends StoreAdapter {
  constructor(userId = 'user', globalEdit = false) {
    ...
    this.getAllAnnotations = (documentId) => {
      return Promise.resolve(getAllAnnotations(documentId));
    };
    ...
    this.addAnnotation = (documentId, pageNumber, annotation) => {
      return new Promise((resolve, reject) => {
        ...
        this.updateAnnotations(documentId, this._userId, annotations);
    ...
    this.editAnnotation = (documentId, annotationId, annotation) => {
      return new Promise((resolve, reject) => {
        ...
        this.updateAnnotations(documentId, annotation.userId, annotations);
        resolve(annotation);
      });
    };
    ...
    this.addComment = (documentId, pageNumber, annotationId, content) => {
      return new Promise((resolve, reject) => {
        let comment = {
          class: 'Comment',
          uuid: uuid(),
    ...
    this.deleteComment = (documentId, commentId) => {
      return new Promise((resolve, reject) => {
        ...
        if (index > -1) {
          annotations.splice(index, 1);
          this.updateAnnotations(documentId, comment.userId, annotations);
        }
    ...
    this.updateAnnotations = (documentId, annotations) => {
      return updateAnnotations(documentId, annotations);
    };
  }
